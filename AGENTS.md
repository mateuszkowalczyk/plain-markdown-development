...
- Multi-agent PMD separates four logical roles: Coordinator owns the ongoing project workflow and process state across iterations, Planner owns technical planning, Worker implements an assigned execution group, and Reviewer independently reviews it.
